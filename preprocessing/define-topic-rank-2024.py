...
def define_topic_rank(number, old_year):
    ...
    cursor.execute("SELECT paper_id FROM PaperVectors WHERE created_date <= '2024-01-01' LIMIT ?", (number,))
...
# 結果をファイルに保存
with open('topic_ranks_2024_new.pkl', 'wb') as f: #ここも適宜かえる
    pickle.dump({
...
print("Ranks saved to 'topic_ranks_2024_new.pkl'")
